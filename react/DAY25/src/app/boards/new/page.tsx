        ...
        <form className={styles["register-form"]}>
          ...
          <div className="flex gap-10">
            <div className="required flex flex-col gap-2 w-1/2">
              ...
              <input type="text" id="post-writer-input" onChange={onChangeWriter} placeholder="작성자 명을 입력해 주세요." />
              <p className="error-message">{errorWriter}</p>
            </div>

            <div className="required flex flex-col gap-2 w-1/2">
              <label htmlFor="post-password-input">비밀번호</label>
              <input type="password" id="post-password" onChange={onChangePassword} placeholder="비밀번호를 입력해 주세요." />
              <p className="error-message">{errorPassword}</p>
            </div>
          </div>
          <div className="required border-b required flex flex-col gap-2">
            <label htmlFor="post-title">제목</label>
            <input type="text" id="post-title" onChange={onChangeTitle} placeholder="제목을 입력해 주세요." />
            <p className="error-message">{errorTitle}</p>
          </div>
          <div className="required flex flex-col gap-2">
            <label htmlFor="post-content">내용</label>
            <textarea id="post-content" onChange={onChangeContent} placeholder="내용을 입력해 주세요." />
